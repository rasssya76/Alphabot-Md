...
exports.botNotAdmin = () => {
    return `_Jaddin Gw admin dulu Su_`
}
...
exports.listMenu = (time, salam, pushname, prefix) => {
    return `*Selamat ${salam} ${pushname} ( ˘ ³˘)♥︎*
*Time Server : ${time}*
*List-Menu R-BOT-Md :*
...
➡️ Tanya owner untuk info lebih lanjut.
...
┃ 𝖦𝖾𝗇𝖽𝖾𝗋 :
┃ 𝖠𝗌𝗄𝗈𝗍 : 
┗❒ 𝖩𝖠𝖭𝖦𝖠𝖭 𝖫𝖠𝖭𝖦𝖦𝖠𝖱 𝖯𝖤𝖱𝖠𝖳𝖴𝖱𝖠𝖭 𝖦𝖱𝖴𝖯 ༼ つ ◕◡◕ ༽つ
 `
}
exports.leave = () =>{
